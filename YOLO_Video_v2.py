...
#  vest and helmet ----------------------------------------------------
                ...
                if class_name == 'Person':
                    ...
                    # Check if the object is safety equipment
                        ...
                        if obj_class in ['Hardhat'] and 'Safety Vest' in [classNames[int(j.cls[0])] for j in boxes]:
                        ...
                        if 'Safety Vest' in [classNames[int(j.cls[0])] for j in boxes]:
                            # Extract bounding box coordinates
                            i_x1, i_y1, i_x2, i_y2 = map(int, i.xyxy[0])
